...
/* harmony export */ });
var toastr = __webpack_require__(901);
...
function createNoteElement(id, obj) {
  ...
  noteWrap.classList.add('note-wrap'); //#region Title
  ...
  titleElement.addEventListener('change', function (e) {
    ...
    console.log(obj);
    (0,_api_noteApi__WEBPACK_IMPORTED_MODULE_0__.updateNote)(obj);
  }); //#endregion
  //#region Note
  ...
  noteElement.addEventListener('change', function (e) {
    obj = {
      id: id,
      title: obj.title,
